...
function weather(location) {
  ...
  $.getJSON(url + "q=" + location + "&APPID=" + key + "&units=imperial", function(data) {
    ...
    var html = "<div><h3>It is " + data.main.temp + " degrees and it outside seems likely " + data.weather[0].description + "</h3><br><img src=http://openweathermap.org/img/w/" + data.weather[0].icon + ".png" + "</div>";
    $("#temp").prepend(html);
    $(".legend2").show();
  })
}
